...
const wineCategories: WineCategory[] = [
  // ... existing red wine categories
  {
    title: "Chardonnay",
    items: [
      {
        name: "Rombauer (Carneros)",
        description:
          "Rich and creamy with flavors of tropical fruit and vanilla. Aged in French oak barrels.",
      },
      {
        name: "Cakebread Cellars (Napa Valley)",
        description:
          "Elegant and balanced with notes of apple, pear, and citrus. Crisp acidity and long finish.",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Kim Crawford (New Zealand)",
        description:
          "Vibrant and zesty with flavors of passionfruit, grapefruit, and fresh herbs.",
      },
      {
        name: "Duckhorn (Napa Valley)",
        description:
          "Bright citrus and tropical fruit aromas with a refreshing mineral finish.",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Dr. Loosen (Germany)",
        description:
          "Crisp and aromatic with notes of green apple, lime, and floral undertones.",
      },
      {
        name: "Chateau Ste. Michelle (Washington)",
        description:
          "Delicate sweetness balanced by acidity, with flavors of peach and apricot.",
      },
    ],
  },
];
