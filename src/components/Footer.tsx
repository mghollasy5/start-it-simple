        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:justify-start lg:items-center mb-8 pb-6 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center lg:items-end">
            <a 
              ...
              className="inline-flex items-center gap-2 rounded-full bg-cafe-gold/10 backdrop-blur-sm hover:bg-cafe-gold/20 transition-all px-4 py-2 text-cafe-gold hover:scale-105 transform mb-2"
            >
